...
class TimeSeriesPage extends StatefulWidget {
  ...
  static Route go() =>
      MaterialPageRoute<void>(builder: (_) => TimeSeriesPage());
...
class _TimeSeriesPageState extends State<TimeSeriesPage> {
  ...
  List<LineSeries<SalesDataModel, DateTime>> _getAddRemovePointSeries() {
    return <LineSeries<SalesDataModel, DateTime>>[
      LineSeries<SalesDataModel, DateTime>(
        ...
        xValueMapper: (SalesDataModel sales, _) => sales.orderDate!,
