...
class CompositeChartPage extends StatefulWidget {
  ...
  @override
  State<CompositeChartPage> createState() => _CompositeChartPageState();
}

class _CompositeChartPageState extends State<CompositeChartPage> {
  ...
  List<StackedBarSeries<SalesDataModel, String>> _getAddRemovePointSeries() {
    return <StackedBarSeries<SalesDataModel, String>>[
      StackedBarSeries<SalesDataModel, String>(
